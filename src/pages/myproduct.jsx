...
const Product1 = () => {
  ...
  const fetchProductData = () => {
    ...
    setImage(product.image?.[0] || product.images?.[0]?.url);
    }
    else{
    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>These are best products in the world don’t miss the opportunity</p>
          <p>Yes, these are best products in the world don’t miss the opportunity</p>
        </div>
      </div>
